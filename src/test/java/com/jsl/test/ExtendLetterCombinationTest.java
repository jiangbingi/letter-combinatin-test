...
public class ExtendLetterCombinationTest {


    private ExtendLetterCombination letterCombination;

    @Before
    public void setup(){
        letterCombination = new ExtendLetterCombination();
    }
    ...
    public void testFindCombination(){
        ...
        // 正常拆分三位数
        digits = new String[]{"2","3", "99"};
        combinationList = letterCombination.findCombination(digits);
        assert combinationList.size() == 72;
